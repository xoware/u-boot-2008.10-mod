...
#define GPIOA_REG_VALUE(offset) (*((volatile unsigned int *)(CNS3000_VEGA_GPIOA_BASE+offset)))
#define GPIOB_REG_VALUE(offset) (*((volatile unsigned int *)(CNS3000_VEGA_GPIOB_BASE+offset)))
