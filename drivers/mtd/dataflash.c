...
int AT91F_DataflashInit (void)
{
	...
	for (i = 0; i < CFG_MAX_DATAFLASH_BANKS; i++) {
        ...
        case MX25L128:
            ...
            break;
        case MX25L256:
            dataflash_info[i].Device.pages_number = 131072;
            dataflash_info[i].Device.pages_size = 256;
            dataflash_info[i].Device.page_offset = 0;
            dataflash_info[i].Device.byte_mask = 0x0;
            dataflash_info[i].Device.cs = cs[i].cs;
	...
	for (i = 0; i < CFG_MAX_DATAFLASH_BANKS; i++) {
		if (dataflash_info[i].id != 0) {
			...
			case MX25L256:
				...
				break;
			case SP_S25FL064A:
				printf("Spansion S25FL064A\n");
				break;				
			case SP_S25FL128P:
				printf("Spansion S25FL128P\n");
				break;				
			case NX_N25Q064:
				printf("Numonyx N25Q064\n");
				break;				
			case AT45DB021:
				printf("AT45DB021\n");
				break;
...
void dataflash_print_info (void)
{
	...
	for (i = 0; i < CFG_MAX_DATAFLASH_BANKS; i++) {
		if (dataflash_info[i].id != 0) {
			...
			switch (dataflash_info[i].id) {
			case MX25L32: printf(" MX25L32"); break;
			case MX25L64: printf(" MX25L64"); break;
			case MX25L128: printf(" MX 25L128"); break;
			case MX25L256: printf(" MX 25L256"); break;
			case SP_S25FL064A: printf(" Spansion S25FL064A"); break;              
			case SP_S25FL128P: printf(" Spansion S25FL128P"); break;              
			case NX_N25Q064: printf(" Numonyx N25Q064"); break;
			case AT45DB021: printf(" AT45DB021"); break;
			case AT45DB161: printf(" AT45DB161"); break;
			case AT45DB321: printf(" AT45DB321"); break;
			case AT45DB642: printf(" AT45DB642"); break;
			case AT45DB128: printf(" AT45DB128"); break;
			}
...
/*---------------------------------------------------------------------------*/
int addr_flash (unsigned long addr)
{
	int addr_valid = 0;
	int i;

	for (i = 0; i < CFG_MAX_FLASH_BANKS; i++) {
		if ((((int) addr) & 0xF0000000) == 0x10000000) {
			addr_valid = 1;
			break;
		}
	}
