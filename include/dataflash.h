...
/*-------------------------------------------------------------------------------------------------*/
/* Winbond --W25X20BL*/
#define W25X20B         0xef3012

/* Macronix -- mx25lxxx */
#define MX25L4006E	0xc22013
#define MX25L32		0xc22016
#define MX25L64		0xc22017
#define MX25L128	0xc22018
#define MX25L256	0xc22019

#define NS_NX25P16	((0xEF << 16) | 0x2015)
#define ST_M25P32	((0x20 << 16) | 0x2016)
#define ST_M25P64	((0x20 << 16) | 0x2017)
#define SP_S25FL064A    ((0x01 << 16) | 0x0216)
#define SP_S25FL128P    ((0x01 << 16) | 0x2018)

#define NX_N25Q064	((0x20 <<16) | 0xba17)
