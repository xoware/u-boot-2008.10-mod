...
#ifndef __CAV_COMMON_CONFIG_H
#define __CAV_COMMON_CONFIG_H
...
#ifdef SDK_FORMAL
#define SDK_VERSION_STRING "Cavium Networks CNS3XXX SDK v" SDK_VERSION " " UBOOT_TYPE
#else
#define SDK_VERSION_STRING "Cavium Networks CNS3XXX SDK informal release after v" SDK_VERSION " " UBOOT_TYPE
#endif
...
//#define CONFIG_BOOTCOMMAND "tftp 0x4000000 bootpImage; go 0x4000000"

#define CONFIG_BOOTARGS "console=ttys0,38400 rootwait root=/dev/mmcblk0p2 init=/linuxrc"
#define CONFIG_BOOTCOMMAND "mmcinit; fatload mmc 0:1 0x4000000 uimage; bootm 0x4000000"
...
#define CONFIG_IPADDR		192.168.1.122		/* static IP I currently own */
#define CONFIG_SERVERIP		192.168.1.161		/* current IP of my dev pc */
...
#define PHYS_SDRAM_1		       	0x20000000	/* SDRAM Bank #1 */
	...
	#ifdef MEM_1024MBIT_WIDTH_8
		#define PHYS_SDRAM_1_SIZE		0x20000000	/* 0x20000000 = 512 MB */
	...
	#define PHYS_SDRAM_1_SIZE		0x04000000	/* 0x04000000 = 64 MB */
#else
	#define PHYS_SDRAM_1_SIZE		0x08000000	/* 0x08000000 = 128 MB */
#endif
...
#define CFG_USB_OHCI_REGS_BASE          CNS3000_VEGA_USB_OHCI_BASE
#define CFG_USB_OHCI_SLOT_NAME          "cns3000"
...
//#define CFG_FLASH_LEGACY_64MiBx16
...
#elif defined(CFG_FLASH_LEGACY_64MiBx16)
	#define PHYS_FLASH_SIZE			0x04000000      /* 64 MB */
	#define CFG_MAX_FLASH_SECT		512             /* 512 max number of sectors on one chip */
...
#define CONFIG_SUPPORT_PFLASH_AND_SFLASH
